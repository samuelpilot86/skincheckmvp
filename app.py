...
if st.session_state.screen == "Accueil":
    ...
    if 'result' in st.session_state:
        ...
        st.markdown(f'<div class="normal-text">This should be a {result} mole (probability: {round(prob, 3)*100}%). Yet, if it is asymmetrical, has an irregular border, several colors, a diameter >6mm and/or has evolved recently, show it to a dermatologist.</div>', unsafe_allow_html=True)
